...
class _UpdateScreenState extends State<UpdateScreen> {
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      ...
                      actions: <Widget>[
                        ...
                        TextButton(
                          onPressed: () {
                            context.read<TransactionDBProvider>()
  ...
  Future updateTransaction(BuildContext ctx) async {
    ...
    final model = TransactionModel(
        ...
        isExpense: widget.selectedValue == "Expense" ? true : false,
        category: selectedCategoryModel,
        amount: widget.selectedAmount,
        description: widget.selectedDescription);

    context.read<TransactionDBProvider>().updateTransaction(model);
    context.read<TransactionDBProvider>().refresh();
  }
}
